...
module.exports = class modcommandsCommand extends BaseCommand {
  ...
  run(client, message, args) {
    ...
    .addField('how to use it?','Simple! \`¿tempban @user reason (//why you do want to tempban this member//) time (//how much time do you want to ban this user//)\` the member will receive a DM with the info of his/her tempban')
    .addField('N-3','¿kick')
    .addField('how to use it?',' \`¿kick @user reason (//why you do want to ban this member//)\`the member will receive a DM with the info of his/her kick')
    .addField('N-4','¿lock')
